...
* The `plot(type = "route")` function can be used to plot the number of examinees routed to each module. The function accepts a `examinee_list` object produced by `maat()`.
...
```{r, out.width = "100%"}
examinee <- maat_output_CI@examinee_list[[1]]
