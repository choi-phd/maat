...
* Plot the true $\theta$ against the estimated $\theta$ across test administrations.
* The arguments of the `plot()` functions: 
  * `x` is the output object produced by `maat()`.
  * `theta_range` is the $\theta$ range used for the scatterplot.
  * `main` is the vector of titles for the plots
